              ...
              <Routes>
                ...
                <Route element={<Layout />}>
                  ...
                  <Route path="conta" element={<AccountLayout />}>
                    ...
                    <Route path="solicitacoes" element={<PartRequests />} />
                  </Route>
                  <Route path="perfil" element={<Navigate to="/conta/perfil" replace />} />
                  <Route path="pedidos" element={<Navigate to="/conta/pedidos" replace />} />
                  <Route path="solicitacoes" element={<Navigate to="/conta/solicitacoes" replace />} />
